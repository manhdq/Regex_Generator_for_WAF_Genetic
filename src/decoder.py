...
def decoder(subsequences, subsequence):
    ...
    for i in range(len(subsequences[0])):
        ...
        if i % 2 == 0 :  ## TODO: Unstable, should add random for this condition
            ## TODO: Should we return '.*' when there are many diffirences?
            if len(set(targets)) > 10 or random.randint(0,99) % 2 == 1 : # many diffirences
                _next = '.*'
            ## TODO: Why 1?
